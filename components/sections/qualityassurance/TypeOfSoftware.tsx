  ...
  return (
    <div className="w-screen py-[2rem]">
      <div className="container mx-auto flex flex-col gap-y-[4rem]">
        ...
        />
        <div className="tech-box bg-[#F9F9F9] h-fit rounded-2xl p-5 items-center lg:flex hidden">
            ...
            <div className="left xl:w-[368px] lg:w-[312px] w-full lg:h-fit h-[150px] rounded-2xl p-5 flex flex-col justify-between">
              <div className="h-fit md:w-full w-full lg:mx-auto mx-0 flex lg:flex-col flex-row justify-between overflow-x-auto gap-y-4">
                {sideBarItems.map((item, i) => (
                  <button
                    key={i}
                    className={`inline-flex justify-start items-center md:w-fit px-3 w-auto lg:text-[26px] text-[12px] lg:py-4 font-semibold ${
        ...
        <div className="h-fit w-full bg-[#F9F9F9] p-4 lg:hidden">
          <Slider {...settings}>
            {sideBarItems.map((item, i) => {
              return (
                <div
                ...
                >
                  {sideBarItemSelected == "Functional Testing" && (
                    <div className="lg:w-[657px] w-full lg:h-[300px] h-fit flex flex-col justify-center gap-y-[2rem] transition-all duration-75">
                      <p>
                        Functional testing lets us analyze a separate part of
                        the application within the context of the entire
                        application. This testing ensures that the system does
                        what users are expecting it to do.
                      </p>
                      <p>
                        In other words, we test the business logic of a product
                        to make sure all the functional objectives are met, and
                        the app or website performs the functionality it is
                        supposed to.
                      </p>
                      <button>
                        <svg
