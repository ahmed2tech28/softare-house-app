...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      <BlurBg img={"/qaservices-header.png"} />
      <div className="absolute top-0 w-full h-full z-10 flex flex-col justify-between  hb:pb-[3rem]">
        ...
        >
          <div className="lg:w-[50%] w-[9-vw] lg:mx-0 mx-auto flex flex-col gap-y-[1rem]">
            ...
            <button
              type={"button"}
              className={`bg-[#0C8CE9] text-white leading-none text-[1rem] py-[1rem] font-semibold f-mon w-[310px] rounded-full`}
            >
              {"Get A personalized estimate"}
            </button>
          </div>
          <div className="sm:w-[50%] w-full flex justify-end lg:items-end items-center lg:h-[80%]">
