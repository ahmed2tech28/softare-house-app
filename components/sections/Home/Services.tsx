...
const Card: React.FC<CardProps> = ({ category, desc, title, link }) => {
  return (
    <div className="mb:w-[407px] w-[95vw] hover-shadow-custom h-[509px] rounded-[2rem] border-[0.5px] border-[#CBD1DC] p-5 py-10 flex flex-col justify-between group cursor-pointer mx-auto">
...
const Services: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="services mb:ml-[4vw] ms-0 overflow-x-auto py-[1rem] cursor-grab 3xl:!mx-auto"
        ref={contentRef}
      >
