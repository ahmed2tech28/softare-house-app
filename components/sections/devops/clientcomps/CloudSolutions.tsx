      ...
      <div className="w-full f-mon flex flex-col gap-y-4 md:w-[40%]">
        {buttons.map((item, i) => {
          return (
            <button
              key={i}
              className="rounded-[33px] font-semibold px-[1.5rem] py-3 sm:text-[24px] text-[14px] w-fit bg-[#F4F4F4] hover:text-white hover:bg-[#0066FF] transition-all duration-100"
              style={{
